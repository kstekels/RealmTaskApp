...
//        cell.textLabel?.text = tasksList.name
    ...
    #warning("Bug with editing when swiping in this block")
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration?  {
        ...
        let swipeActions = UISwipeActionsConfiguration(actions: [contextItemEdit, contextItemDelete, contextItemDone])
        return swipeActions
    }
}
